...
<html>
    ...
    <head>
        ...
        <!-- Datatables CSS -->
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('') }}js/vendor/plugins/datatables/media/css/dataTables.bootstrap.css">

        <!-- Datatables Addons CSS -->
        <link rel="stylesheet" type="text/css" href="{{ URL::asset('') }}js/vendor/plugins/datatables/media/css/dataTables.plugins.css">
        <!-- Theme CSS -->  
